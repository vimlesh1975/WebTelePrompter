...
const Scroll = ({ scrollContainerStyle, scrollingTextStyle,
    ...
    }, [scaleFactor, speed, doubleClickedPosition, startPosition, loggedPositions, currentStoryNumber, storyLines, contentRefs, textRef, setCurrentStoryNumber, setCurrentSlug, setLoggedPositions, dispatch, scale, crossedLines, setNewPosition, setSpeed,]);
